...
Перечень ключевых слов: система управления, бизнес, ресторан, касса, программно-информационная система, база данных, заказ, отчёт, автоматизаия, оптимизация, классы, сотрудники, прибль, технологические карты, повар, администратор, официат, управляющий.
